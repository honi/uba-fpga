...
HD_PWD='/home/jb/fpga/soundfx/soundfx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_master_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_master_top.tcl -notrace
