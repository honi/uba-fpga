...
HD_PWD='/home/jb/fpga/soundfx/soundfx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_master_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_master_top.tcl
